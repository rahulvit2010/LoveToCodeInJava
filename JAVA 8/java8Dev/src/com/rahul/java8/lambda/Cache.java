package com.rahul.java8.lambda;
...
public class Cache {		
    ...
    public static void main(String[] args) {
		...
		// Lambdas
		Arrays.parallelSort(recommendedItems.items,(o1,o2)-> new Integer(o1.getTitle().length()).compareTo(new Integer(o2.getTitle().length())));
